...
function scr_RefreshParticleSystems(pArray)
{
	
	var length = ds_list_size(pArray);
	var currentTileParticleEffects = undefined;
	
	for (var i = 0; i < length; i++)
	{
		currentTileParticleEffects = ds_list_find_value(pArray, i);
